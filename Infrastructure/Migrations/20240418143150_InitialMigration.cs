        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ContentOrdinalPositionIsNotNegative", "[OrdinalPosition] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_NoteOrdinalPositionIsNotNegative", "[OrdinalPosition] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_SectionId_OrdinalPosition",
                table: "Notes",
                columns: new[] { "SectionId", "OrdinalPosition" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sections_ArticleId_OrdinalPosition",
                table: "Sections",
